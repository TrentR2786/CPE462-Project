...
int main(int argc, char* argv[]) {
  ...
  //Deskew code based on modified version of code from http://felix.abecassis.me/2011/10/opencv-rotation-deskewing/
  ...
  */
  ...
  //Result iterator code based on modified example from Tesseract documentation: https://tesseract-ocr.github.io/tessdoc/APIExample.html
